...
VALUES ('系统管理', 'system', 'Layout', 3, 'M', '0', '0', 'settings', 1, NULL, NULL)
ON CONFLICT DO NOTHING;
...
-- 12.3 系统监控目录
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
VALUES ('系统监控', 'monitor', 'Layout', 4, 'M', '0', '0', 'monitor', 1, NULL, NULL)
ON CONFLICT DO NOTHING;
...
-- 12.5 系统工具目录
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
VALUES ('系统工具', 'tool', 'Layout', 5, 'M', '0', '0', 'wrench', 1, NULL, NULL)
ON CONFLICT DO NOTHING;
...
-- 19.1 APP配置目录
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
VALUES ('APP配置', 'app-config', 'Layout', 2, 'M', '0', '0', 'smartphone', 1, NULL, NULL)
ON CONFLICT DO NOTHING;

-- 19.2 APP配置子菜单
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '启动页配置', 'splash', 'app-config/splash/index', 1, 'C', '0', '0', 'image', 1, menu_id, 'app:splash:list'
FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '登录页配置', 'login', 'app-config/login/index', 2, 'C', '0', '0', 'log-in', 1, menu_id, 'app:login:list'
FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL
ON CONFLICT DO NOTHING;
...
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '下载页配置', 'download', 'app-config/download/index', 4, 'C', '0', '0', 'download', 1, menu_id, 'app:download:list'
FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '版本管理', 'version', 'app-config/version/index', 5, 'C', '0', '0', 'package', 1, menu_id, 'app:version:list'
FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '推广统计', 'promotion', 'app-config/promotion/index', 6, 'C', '0', '0', 'trending-up', 1, menu_id, 'app:promotion:list'
FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL
ON CONFLICT DO NOTHING;

-- 19.3 启动页配置按钮
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '启动页查询', '', '', 1, 'F', '1', '0', '#', 1, menu_id, 'app:splash:query'
FROM sys_menu WHERE path = 'splash' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '启动页新增', '', '', 2, 'F', '1', '0', '#', 1, menu_id, 'app:splash:add'
FROM sys_menu WHERE path = 'splash' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '启动页修改', '', '', 3, 'F', '1', '0', '#', 1, menu_id, 'app:splash:edit'
FROM sys_menu WHERE path = 'splash' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '启动页删除', '', '', 4, 'F', '1', '0', '#', 1, menu_id, 'app:splash:remove'
FROM sys_menu WHERE path = 'splash' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

-- 19.4 登录页配置按钮
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '登录页查询', '', '', 1, 'F', '1', '0', '#', 1, menu_id, 'app:login:query'
FROM sys_menu WHERE path = 'login' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '登录页修改', '', '', 2, 'F', '1', '0', '#', 1, menu_id, 'app:login:edit'
FROM sys_menu WHERE path = 'login' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

-- 19.5 下载页配置按钮
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '下载页查询', '', '', 1, 'F', '1', '0', '#', 1, menu_id, 'app:download:query'
FROM sys_menu WHERE path = 'download' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '下载页修改', '', '', 2, 'F', '1', '0', '#', 1, menu_id, 'app:download:edit'
FROM sys_menu WHERE path = 'download' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

-- 19.6 推广统计按钮
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '推广渠道查询', '', '', 1, 'F', '1', '0', '#', 1, menu_id, 'app:promotion:query'
FROM sys_menu WHERE path = 'promotion' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '推广渠道新增', '', '', 2, 'F', '1', '0', '#', 1, menu_id, 'app:promotion:add'
FROM sys_menu WHERE path = 'promotion' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '推广渠道修改', '', '', 3, 'F', '1', '0', '#', 1, menu_id, 'app:promotion:edit'
FROM sys_menu WHERE path = 'promotion' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '推广渠道删除', '', '', 4, 'F', '1', '0', '#', 1, menu_id, 'app:promotion:remove'
FROM sys_menu WHERE path = 'promotion' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

-- 19.7 版本管理按钮
INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '版本查询', '', '', 1, 'F', '1', '0', '#', 1, menu_id, 'app:version:query'
FROM sys_menu WHERE path = 'version' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '版本新增', '', '', 2, 'F', '1', '0', '#', 1, menu_id, 'app:version:add'
FROM sys_menu WHERE path = 'version' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '版本修改', '', '', 3, 'F', '1', '0', '#', 1, menu_id, 'app:version:edit'
FROM sys_menu WHERE path = 'version' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;

INSERT INTO sys_menu (menu_name, path, component, order_num, menu_type, visible, status, icon, is_frame, parent_id, perms)
SELECT '版本删除', '', '', 4, 'F', '1', '0', '#', 1, menu_id, 'app:version:remove'
FROM sys_menu WHERE path = 'version' AND parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
ON CONFLICT DO NOTHING;
...
-- 19.9 为超级管理员分配APP配置管理权限
INSERT INTO sys_role_menu (role_id, menu_id)
SELECT r.role_id, m.menu_id
FROM sys_role r, sys_menu m
WHERE r.role_key = 'admin' AND r.del_flag = '0'
  AND (
    (m.path = 'app-config' AND m.parent_id IS NULL)
    OR m.parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
    OR m.parent_id IN (
      SELECT menu_id FROM sys_menu 
      WHERE parent_id = (SELECT menu_id FROM sys_menu WHERE path = 'app-config' AND parent_id IS NULL)
    )
  )
ON CONFLICT DO NOTHING;

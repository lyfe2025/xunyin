...
// 常用图标列表 (按使用频率排序)
const commonIcons = [
  'Home', 'User', 'Users', 'Settings', 'Menu', 'Search', 'Plus', 'Edit', 'Trash2',
  'Eye', 'EyeOff', 'Lock', 'Unlock', 'Key', 'Shield', 'ShieldCheck',
  'File', 'FileText', 'Folder', 'FolderOpen', 'Database', 'Server',
  ...
  'LogIn', 'LogOut', 'Power', 'RefreshCw', 'RotateCw',
  'Download', 'Upload', 'Share', 'Link', 'ExternalLink',
  'Image', 'Camera', 'Video', 'Music', 'Mic',
  'Heart', 'Star', 'Bookmark', 'Flag', 'Tag', 'Tags',
  ...
  'Truck', 'Car', 'Plane', 'Train', 'Ship',
  'Building', 'Building2', 'Store', 'Warehouse', 'Factory',
  'Briefcase', 'GraduationCap', 'Award', 'Trophy', 'Medal',
  'Activity', 'BarChart', 'BarChart2', 'PieChart', 'TrendingUp', 'TrendingDown',
  'List', 'ListOrdered', 'Grid', 'Layout', 'LayoutGrid', 'LayoutDashboard',
  'Table', 'Columns', 'Rows', 'Sidebar',
  'Code', 'Terminal', 'Command', 'Hash', 'AtSign',
  'Clipboard', 'ClipboardList', 'ClipboardCheck',
  'Filter', 'SlidersHorizontal', 'Sliders',
  'Maximize', 'Minimize', 'Maximize2', 'Minimize2', 'Expand', 'Shrink',
  'Copy', 'Scissors', 'Paperclip', 'Pin', 'PinOff',
  'Save', 'Printer', 'Archive', 'ArchiveRestore',
  'Play', 'Pause', 'Stop', 'SkipBack', 'SkipForward', 'FastForward', 'Rewind',
  'Volume', 'Volume1', 'Volume2', 'VolumeX',
  'Headphones', 'Speaker', 'Radio',
  'Cpu', 'HardDrive', 'MemoryStick', 'Usb',
  'Network', 'Rss', 'Podcast', 'Cast',
  'QrCode', 'Barcode', 'Scan', 'ScanLine',
  'Fingerprint', 'UserCheck', 'UserPlus', 'UserMinus', 'UserX',
  'Contact', 'Contact2', 'BadgeCheck', 'BadgeAlert', 'BadgeInfo',
  'CircleUser', 'CircleDot', 'Circle', 'Square', 'Triangle',
  'Hexagon', 'Octagon', 'Pentagon',
  'Smile', 'Frown', 'Meh', 'Angry', 'Laugh',
  'ThumbsUp', 'ThumbsDown', 'Hand', 'Handshake',
  'Gift', 'Cake', 'PartyPopper', 'Sparkles', 'Flame',
  'Lightbulb', 'Lamp', 'LampDesk',
  'Book', 'BookOpen', 'BookMarked', 'Library', 'Newspaper',
  'Pen', 'Pencil', 'PenTool', 'Highlighter', 'Eraser',
  'Ruler', 'Palette', 'Paintbrush', 'Pipette',
  'Crop', 'Move', 'Grab', 'Hand',
  'ZoomIn', 'ZoomOut', 'Focus',
  'Layers', 'Layers2', 'Layers3',
  'Box', 'Boxes', 'Cube', 'Cylinder',
  'Shapes', 'Component', 'Puzzle',
  'Wrench', 'Hammer', 'Screwdriver', 'Nut',
  'Cog', 'Settings2', 'Gauge',
  'Thermometer', 'Droplet', 'Wind', 'Snowflake', 'Umbrella',
  'Tree', 'Flower', 'Leaf', 'Sprout',
  'Bug', 'Skull', 'Ghost', 'Bot',
  'Rocket', 'Satellite', 'Orbit',
  'Anchor', 'Compass', 'LifeBuoy',
  'Tent', 'Mountain', 'Waves',
  'Coffee', 'Wine', 'Beer', 'Utensils', 'ChefHat',
  'Pill', 'Stethoscope', 'Syringe', 'Bandage', 'HeartPulse',
  'Dumbbell', 'Bike', 'Footprints',
  'Gamepad', 'Gamepad2', 'Dice1', 'Dice2', 'Dice3', 'Dice4', 'Dice5', 'Dice6',
  'Music2', 'Music3', 'Music4',
  'Tv', 'Tv2', 'MonitorPlay', 'Clapperboard',
  'Megaphone', 'Siren', 'Bell', 'BellRing', 'BellOff',
]
      ...
      <ScrollArea class="h-[280px]">
        <div class="grid grid-cols-8 gap-1 p-2">
          <Button
            ...
            class="h-8 w-8"
            :class="{
              'bg-primary/10 text-primary': modelValue === iconName.replace(/([a-z])([A-Z])/g, '$1-$2').toLowerCase()
            }"
            :title="iconName"

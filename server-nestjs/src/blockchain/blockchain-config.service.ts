...
export class BlockchainConfigService {
  ...
  async getChainConfig(): Promise<ChainConfig> {
    ...
    return {
      provider:
        (configMap['chain.provider'] as ChainConfig['provider']) || 'local',
      antchain: {
        appId: configMap['chain.antchain.appId'] || '',
        privateKey: configMap['chain.antchain.privateKey'] || '',
        endpoint:
          configMap['chain.antchain.endpoint'] ||
          'https://rest.antchain.alipay.com',
      },
      bsn: {
      ...
      timestamp: {
        ...
        endpoint:
          configMap['chain.timestamp.endpoint'] ||
      ...
      zhixin: {
        ...
        endpoint:
          configMap['chain.zhixin.endpoint'] ||
          'https://tbaas.tencentcloudapi.com',
      },
    };
  }

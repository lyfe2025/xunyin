...
/// 
/// 配色体系：「中国红 + 黛青」双色体系
/// - accent (中国红): 品牌主色，用于主要按钮、CTA、重要操作
/// - primary (黛青): 辅助色，用于装饰、阴影、次要元素
/// 
/// 详细规范见: .kiro/steering/flutter-colors.md
class AppColors {
  AppColors._();

  // ============ 品牌主色 - 中国红（用于主要按钮、CTA、重要操作） ============
  ...
  // ============ 印记专用色 ============
  static const Color sealGold = Color(0xFFE6B422); // 金色印记
